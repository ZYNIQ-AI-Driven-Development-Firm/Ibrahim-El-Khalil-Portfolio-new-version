    ...
    extend: {
      colors: {
        ...
        header: {
          ...
          50: 'rgb(var(--color-header) / 0.05)',
          100: 'rgb(var(--color-header) / 0.1)',
          200: 'rgb(var(--color-header) / 0.2)',
          300: 'rgb(var(--color-header) / 0.3)',
          400: 'rgb(var(--color-header) / 0.4)',
          500: 'rgb(var(--color-header) / 1)',
        },
      },
    },
  },
