...
class Mem0Service:
    ...
    def __init__(self):
        ...
        try:
            # Temporarily disable Mem0 to avoid API conflicts
            # The main AI chat works perfectly without memory for now
            logger.info("Mem0 disabled to avoid API conflicts. Chat functionality works without memory.")
            self.memory = None
            return
